...
if (!$cfg->demo_login_enabled) {
    $errorMessage = _('Demo Login ist nicht aktiviert!');
} else {
    ...
    if (isset($_POST['demo_login_password'])) {
        ...
        if ($_POST['demo_login_password'] == $cfg->demo_login_password) {
            ...
            $errorMessage = _('Demo Passwort ist falsch');
        }
    }
}
...
<div class="well" style="width: 400px; margin: auto">
    ...
    <form action="" method="POST" role="form">
        <div class="form-group">
            <label for="demo_login_password"><?= _('Passwort') ?>
                <input name="demo_login_password" type="password" class="form-control" style="width: 300px;"></label>
        </div>
        <br/>
