...
db.execute("""INSERT INTO ratingitem (id, name, description, category, creation_author, creation_time) VALUES 
     ...
     (NULL, "Chef", "Chef, das Tool zur Systemautomatisierung", "infra", "smanck", """+db.time_now()+"""),
     (NULL, "Puppet", "Puppet, das Tool zur Systemautomatisierung", "infra", "smanck", """+db.time_now()+"""),
...
db.execute("""INSERT INTO category (id, name, description, orderindex) VALUES 
                ...
                ("infra", "Infrastruktur & Tooling", "In diese Kategorie geh&ouml;ren alle Aspekte zum Management von Infrastruktur, Automatisierung, CI/CD. Sowie Toolchain Themen z.B. maven.", 2),
